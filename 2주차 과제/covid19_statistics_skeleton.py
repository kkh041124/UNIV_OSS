def normalize_data(n_cases, n_people, scale):
    # TODO) Calculate the number of cases per its population 인구당 케이스 수 계산
    norm_cases = []
...
#n_people : 지역별 인구, n_covid : 지역별 신규 코로나 환자
...
for idx, pop in enumerate(n_people):
    ...
    # TODO) The ratio of new cases to the total 전체 신규 사례 대비 신규 사례 비율
